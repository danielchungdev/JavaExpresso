...
?>
            ...
            <div id="content">
                <h1 id="lesson_header">Lesson 1</h1>
                <h2 id="lesson_title">Print Statements</h2>
            ...
            <div id="quiz">
                ...
                <form>
                    <p class="question" id="q1">This is a question on print statements?</p>
                        <input type="radio" name="a1" value="A" id="A"><label for="A">Answer 1</label><br/>
                        <input type="radio" name="a1" value="B" id="B"><label for="B">Answer 2</label><br/>
                        <input type="radio" name="a1" value="C" id="C"><label for="C">Answer 3</label><br/>
                        <input type="radio" name="a1" value="D" id="D"><label for="D">Answer 4</label><br/>
                </form>
            </div>
